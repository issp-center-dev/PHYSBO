...
PHYSBO のソースコードは `Mozilla Public License version 2.0（MPL v2） <https://www.mozilla.org/en-US/MPL/2.0/>`_ (`日本語訳 <https://www.mozilla.jp/documents/mpl/2.0/>`_) のもとで公開・頒布されています。
