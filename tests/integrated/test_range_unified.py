...
class TestRangeUnified:
    def setup_method(self):
        ...
        self.vid_ref = {
            ("PI", "ParEGO", 0): 0.10445870896711029,
            ("EI", "ParEGO", 0): 0.14511676701160858,
            ("TS", "ParEGO", 0): 0.11451168599411266,

            ("PI", "NDS", 0): 0.1119472197450172,
            ("EI", "NDS", 0): 0.12220607591910027,
            ("TS", "NDS", 0): 0.15968650725088385,

            ("PI", "ParEGO", 10): 0.1467432903550019,
            ("EI", "ParEGO", 10): 0.10784501521762047,
            ("TS", "ParEGO", 10): 0.17270427551951528,
